...
import { EMAIL_REGEX, USER_APIS } from "@repo/ui/config";
...
export const Footer = () => {
  const handleSubscribe = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (email && EMAIL_REGEX.test(email)) {
      fetch(`${USER_APIS.SUPPORT.SUBSCRIPTIONS}`, {
        method: "POST",
        headers: {
          ...
          <div className="lg:ui-w-2/3 ui-w-full ui-px-12 lg:ui-px-4 ui-text-white ui-flex ui-flex-col">
            ...
            <div className="ui-mt-8">
              <div className="ui-w-full ui-text-gray-300 ui-text-xl">
                Subscribe for updates. We will send you updates about the
                upcoming features and vendors being added.
              </div>
              <form onSubmit={handleSubscribe} className="ui-flex ui-flex-col ui-mt-4 sm:ui-flex-row ui-w-full md:ui-w-2/3">
                <input
                  name="email"
                  placeholder="Email"
                  required
